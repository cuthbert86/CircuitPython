# This is the main.py code that's running on my pico 2 W  with it's DHT22 sensor.  I've been testing it and it's never stopped.
...
dhtDevice = adafruit_dht.DHT22(board.GP15)                                                                                                                              
...
#dq = collections.deque(len=100)
#dq.append(temperature_c)
"""
def ave_mean(dq):
...
aio_key = "aio_hIYE64BDpy95QLCWNu6bIIFn8bfE"
...
#    picoAverage_feed = aio_username + "/feeds/AverageTemp"
